...
;; @generated by Idris 0.8.0-1c630e67c, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define csegen-2(delay (vector (lambda (arg-5917) (lambda (arg-5920) (+ arg-5917 arg-5920))) (lambda (arg-5927) (lambda (arg-5930) (* arg-5927 arg-5930))) (lambda (arg-5937) arg-5937))))
(define PersistentSegTree-u--C-60C-43C-62_Semigroup_C-40SumC-32C-36aC-41 (lambda (arg-1 arg-2 arg-3) (let ((e-1 (vector-ref arg-1 0))) ((e-1 arg-2) arg-3))))
(define PersistentSegTree-u--neutral_Monoid_C-40SumC-32C-36aC-41 (lambda (arg-1) (let ((e-3 (vector-ref arg-1 2))) (e-3 0))))
(define csegen-5(delay (cons (lambda (arg-8495) (lambda (arg-8498) (PersistentSegTree-u--C-60C-43C-62_Semigroup_C-40SumC-32C-36aC-41 (force csegen-2) arg-8495 arg-8498))) (PersistentSegTree-u--neutral_Monoid_C-40SumC-32C-36aC-41 (force csegen-2)))))
...
(define csegen-14(delay (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Integer u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_Integer u--d u--x))))))
(define u--prim__sub_Integer (lambda (arg-0 arg-1) (- arg-0 arg-1)))
(define PersistentSegTree-half (lambda (arg-0) (cond ((equal? arg-0 0) 0)(else (let ((e-0 (- arg-0 1))) (cond ((equal? e-0 0) 0)(else (let ((e-1 (- e-0 1))) (+ (PersistentSegTree-half e-1) 1)))))))))
...
(define PersistentSegTree-rangeHi (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (let ((e-2 (vector-ref arg-1 2))) e-2)) (else (let ((e-6 (vector-ref arg-1 2))) e-6)))))
(define PersistentSegTree-splitAtC-39 (lambda (arg-1 arg-2) (cond ((equal? arg-1 0) (cons '() arg-2))(else (let ((e-0 (- arg-1 1))) (if (null? arg-2) (cons '() '()) (let ((e-3 (car arg-2))) (let ((e-4 (cdr arg-2))) (let ((sc1 (PersistentSegTree-splitAtC-39 e-0 e-4))) (let ((e-2 (car sc1))) (let ((e-5 (cdr sc1))) (cons (cons e-3 e-2) e-5))))))))))))
(define PersistentSegTree-value (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (let ((e-3 (vector-ref arg-1 3))) e-3)) (else (let ((e-7 (vector-ref arg-1 3))) e-7)))))
(define PersistentSegTree-n--2833-1006-u--go (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-4) (vector 0 (+ arg-3 1) arg-3 (let ((e-2 (cdr arg-1))) e-2)) (let ((e-2 (car arg-4))) (let ((e-3 (cdr arg-4))) (if (null? e-3) (vector 0 arg-3 arg-3 e-2) (let ((u--k (PersistentSegTree-half (PreludeC-45TypesC-45List-lengthTR arg-4)))) (let ((sc2 (PersistentSegTree-splitAtC-39 u--k arg-4))) (let ((e-5 (car sc2))) (let ((e-4 (cdr sc2))) (let ((u--lt (PersistentSegTree-n--2833-1006-u--go arg-1 arg-2 arg-3 e-5))) (let ((u--rt (PersistentSegTree-n--2833-1006-u--go arg-1 arg-2 (+ arg-3 u--k) e-4))) (vector 1 arg-3 (PersistentSegTree-rangeHi u--rt) (let ((e-1 (car arg-1))) ((e-1 (PersistentSegTree-value u--lt)) (PersistentSegTree-value u--rt))) u--lt u--rt)))))))))))))
(define PersistentSegTree-u--show_Show_C-40SumC-32C-36aC-41 (lambda (arg-1 arg-2) (let ((e-1 (car arg-1))) (e-1 arg-2))))
(define PersistentSegTree-rangeLo (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (let ((e-1 (vector-ref arg-1 1))) e-1)) (else (let ((e-5 (vector-ref arg-1 1))) e-5)))))
...
(define PersistentSegTree-update (lambda (arg-1 arg-2 arg-3 arg-4) (let ((sc0 (let ((sc1 (PreludeC-45Types-u--C-60_Ord_Nat arg-2 (PersistentSegTree-rangeLo arg-4)))) (cond ((equal? sc1 1) 1) (else (PreludeC-45Types-u--C-62_Ord_Nat arg-2 (PersistentSegTree-rangeHi arg-4))))))) (cond ((equal? sc0 1) arg-4) (else (case (vector-ref arg-4 0) ((0) (let ((e-1 (vector-ref arg-4 1))) (let ((e-2 (vector-ref arg-4 2))) (let ((e-3 (vector-ref arg-4 3))) (vector 0 e-1 e-2 (arg-3 e-3)))))) (else (let ((e-5 (vector-ref arg-4 1))) (let ((e-6 (vector-ref arg-4 2))) (let ((e-8 (vector-ref arg-4 4))) (let ((e-9 (vector-ref arg-4 5))) (let ((u--ltC-39 (PersistentSegTree-update arg-1 arg-2 arg-3 e-8))) (let ((u--rtC-39 (PersistentSegTree-update arg-1 arg-2 arg-3 e-9))) (vector 1 e-5 e-6 (let ((e-1 (car arg-1))) ((e-1 (PersistentSegTree-value u--ltC-39)) (PersistentSegTree-value u--rtC-39))) u--ltC-39 u--rtC-39))))))))))))))
...
(define PersistentSegTree-query (lambda (arg-1 arg-2 arg-3 arg-4) (let ((sc0 (let ((sc1 (PreludeC-45Types-u--C-60_Ord_Nat arg-3 (PersistentSegTree-rangeLo arg-4)))) (cond ((equal? sc1 1) 1) (else (PreludeC-45Types-u--C-62_Ord_Nat arg-2 (PersistentSegTree-rangeHi arg-4))))))) (cond ((equal? sc0 1) (let ((e-2 (cdr arg-1))) e-2)) (else (let ((sc1 (let ((sc2 (PreludeC-45Types-u--C-60C-61_Ord_Nat arg-2 (PersistentSegTree-rangeLo arg-4)))) (cond ((equal? sc2 1) (PreludeC-45Types-u--C-60C-61_Ord_Nat (PersistentSegTree-rangeHi arg-4) arg-3)) (else 0))))) (cond ((equal? sc1 1) (PersistentSegTree-value arg-4)) (else (case (vector-ref arg-4 0) ((0) (let ((e-3 (vector-ref arg-4 3))) e-3)) (else (let ((e-8 (vector-ref arg-4 4))) (let ((e-9 (vector-ref arg-4 5))) (let ((e-1 (car arg-1))) ((e-1 (PersistentSegTree-query arg-1 arg-2 arg-3 e-8)) (PersistentSegTree-query arg-1 arg-2 arg-3 e-9)))))))))))))))
(define PersistentSegTree-bump (lambda (arg-0 arg-1) (+ arg-1 arg-0)))
(define PersistentSegTree-commit (lambda (arg-1 arg-2 arg-3 arg-4) (let ((e-1 (car arg-4))) (let ((e-2 (cdr arg-4))) (cons (PersistentSegTree-update arg-1 arg-2 arg-3 e-1) (cons e-1 e-2))))))
(define PersistentSegTree-build (lambda (arg-1 arg-2) (PersistentSegTree-n--2833-1006-u--go arg-1 arg-2 0 arg-2)))
(define PersistentSegTree-init (lambda (arg-1 arg-2) (cons (PersistentSegTree-build arg-1 arg-2) '())))
...
(define PersistentSegTree-main (let ((u--h0 (PersistentSegTree-init (force csegen-5) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) eta-0) (cons 1 (cons 3 (cons 5 (cons 7 '())))))))) (let ((u--h1 (PersistentSegTree-commit (force csegen-5) 2 (lambda (eta-0) (PersistentSegTree-bump 10 eta-0)) u--h0))) (let ((u--h2 (PersistentSegTree-commit (force csegen-5) 0 (lambda (eta-0) (PersistentSegTree-bump 100 eta-0)) u--h1))) (lambda (world-0) (let ((act-1 (PreludeC-45IO-prim__putStr (string-append (PersistentSegTree-u--show_Show_C-40SumC-32C-36aC-41 (force csegen-14) (PersistentSegTree-query (force csegen-5) 0 3 (let ((e-1 (car u--h0))) e-1))) "\xa;") world-0))) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (PersistentSegTree-u--show_Show_C-40SumC-32C-36aC-41 (force csegen-14) (PersistentSegTree-query (force csegen-5) 0 3 (let ((e-1 (car u--h1))) e-1))) "\xa;") world-0))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (PersistentSegTree-u--show_Show_C-40SumC-32C-36aC-41 (force csegen-14) (PersistentSegTree-query (force csegen-5) 0 3 (let ((e-1 (car u--h2))) e-1))) "\xa;") world-0))) (((let ((e-2 (cdr u--h2))) (if (null? e-2) (lambda () (lambda (eta-0) 'erased)) (let ((e-4 (car e-2))) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (PersistentSegTree-u--show_Show_C-40SumC-32C-36aC-41 (force csegen-14) (PersistentSegTree-query (force csegen-5) 0 3 e-4)) "\xa;") eta-0))))))) world-0)))))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO PersistentSegTree-main)
